...
In this study, the retention loss by tunneling emission of trapped electrons in Poisson distribution of the programmed cells are going to be shown by using the calibrated TCAD simulation.
